...
barplot(scores,
        ...
        xlab = "Môn học",
        ylab = "Điểm",
        col = c("red", "lightblue", "green", "yellow","pink"),
        ylim = c(0, 10)
)
...
# Histogram 20 bins
hist(exam_scores,
     main = "Histogram với 20 bins",
     xlab = "Điểm thi",
     ylab = "Số lượng sinh viên",
     breaks = 20,
     col = "blue"
     )
...
boxplot(Petal.Length ~ Species,
        data = iris,
        col = c("red","green","blue"),
        main = "So sánh Petal Length giữa các loài Iris",
        xlab = "Loài",
        ylab = "Petal Length")
...
plot(mtcars$hp, mtcars$mpg,
     col = mtcars$cyl,
     pch = 19,
     main = "Quan hệ giữa Horsepower và MPG",
     xlab = "Horsepower (hp)",
